        ...
        <div v-if="mainVisible">
            <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
                <div class="col-xs-4">
                    ...
                    <el-form-item>
                        <el-select v-model="dataForm.street" @change = "getCommunity()"  clearable placeholder="请选择镇/街" :disabled="selectData.select">
                            <el-option
                                    v-for="item in selectData.town"
                    ...
                    <el-form-item>
                        <el-select v-model="dataForm.community" :disabled = "selectData.select && selectData.village != null"  clearable placeholder="请选择村/社区">
                            <el-option
                                    v-for="item in opt2"
                                    :key="item.adminUnitId"
                                    :label="item.adminUnitName"
                ...
                <div class="col-xs-4">
                    ...
                    <el-form-item>
                        <el-button @click="getDataList(dataForm.statisticalDate, true)" type="primary">查询</el-button>
                    </el-form-item>
                </div>
            </el-form>
            <el-table
    ...
    export default {
        ...
        methods: {
                ...
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        if (this.selectData.select) {
                            this.dataForm.street = this.selectData.town[0].adminUnitId
                            this.getCommunity();
                            if (this.selectData.village) {
                                this.dataForm.community = this.selectData.village[0].adminUnitId
                            } else {
            ...
            getDataList(date, init) {
                ...
                this.$http({
                    ...
                    params: this.$http.adornParams({
                        ...
                        checkDate:this.dataForm.statisticalDate,
            ...
            addOrUpdateHandle(id) {
                ...
                this.$nextTick(() => {
                    this.$refs.addOrUpdate.init(id,this.dataForm.statisticalDate)
                })
            },
        }
    }
