                ...
                <el-row style="margin-top: -25px">
                    <el-col :span="9">
                        <el-form-item label="核定日期：">
                            <el-input v-model="dataForm.checkDate" disabled style = "width: 70%"></el-input>
                            <!--<el-date-picker-->
            ...
            <div id="peoInfo" style="width: 100%;background-color: #d7d5d5;padding: 0 2% 2% 2%;">
                ...
                <el-row style="margin-top: -25px">
                    <el-col :span="24" id="province">
                        <el-form-item label="曾经暴露的高风险地区：" prop="provinceId">
    ...
    export default {
        ...
        methods: {
            ...
            selectList() {
                ...
                this.$http({
                    url: this.$http.adornUrl(`/admin/getExposeArea`),
                    method: 'get',
                    params: this.$http.adornParams({})
                }).then(({data}) => {
                    if (data && data.code === 0) {
                        this.options0 = data.entityList
                    }
                    //this.dataListLoading = false
                });
                this.$http({
