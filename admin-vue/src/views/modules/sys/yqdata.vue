    ...
    <div class="mod-user">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <div class="col-xs-4">
                ...
                <el-form-item>
                    <el-select v-model="dataForm.community" clearable placeholder="请选择村/社区" :disabled="selectData.select && selectData.village != null">
                        <el-option
                                v-for="item in opt2"
                                :key="item.adminUnitId"
                                :label="item.adminUnitName"
    ...
    export default {
        ...
        methods: {
            ...
            getDataList(date, init) {
                ...
                paramsEntity.checkDate = this.dataForm.statisticalDate
